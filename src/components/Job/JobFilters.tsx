...
const JobFilters: React.FC<JobFiltersProps> = ({ filters, onFilterChange, totalJobs }) => {
  ...
  const handleFilterChange = (filterType: 'jobType' | 'experience' | 'salaryRange', value: string) => {
