 ...
 * WCAG: Proper form validation, password strength indicator, keyboard navigation
 */
      ...
      <div className="max-w-2xl w-full space-y-8">
        ...
        <div className="card p-8">
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                  ...
                  <div className="space-y-1 mt-3">
                    {passwordRequirements.map((req, index) => {
                      ...
                      return (
                        ...
                        >
                          {isMet ? (
                            <Check className="w-3 h-3 text-green-500 mr-2" aria-hidden="true" />
                          ) : (
                            <X className="w-3 h-3 text-gray-400 mr-2" aria-hidden="true" />
                          )}
            ...
            <div className="space-y-4">
              ...
              <Checkbox
                label="Subscribe to newsletter for job updates and career tips"
        ...
        <div className="text-center text-sm text-gray-500 dark:text-gray-400">
          <p className="sr-only">
            ...
            Use arrow keys to move between password requirements.
          </p>
        </div>
      </div>
    </main>
