...
export const ACCESSIBILITY = {
  FOCUS_RING_COLOR: '#3b82f6', // primary-500
...
export const API_ENDPOINTS = {
  JOBS: '/api/jobs',
  JOB_DETAILS: (id) => `/api/jobs/${id}`,
  APPLY: (id) => `/api/jobs/${id}/apply`,
  SAVE_JOB: (id) => `/api/jobs/${id}/save`,
  UNSAVE_JOB: (id) => `/api/jobs/${id}/unsave`,
